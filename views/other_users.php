        ...
        <div class="col-xs-12">
            <paper-card class="col-xs-12" heading="Users from other sites" alt="Users from other sites">
                <div class="card-content">
                    <p>Users from <a href="http://myxaxi.net/service/external_users.php">http://myxaxi.net/service/external_users.php</a></p>
                    <?php
                    $ch = curl_init();

                    curl_setopt_array($ch, array(
                        CURLOPT_URL => 'http://myxaxi.net/service/external_users.php',
